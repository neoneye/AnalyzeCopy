...
------------------------------------------------------------
IDEA: generate a CSV file with the results

IDEA: take a CSV file and format it as pretty HTML.. so that 
a human can reorder the rows/columns.
...
IDEA: test XATTR_SHOWCOMPRESSION with listxattr
